...
def load_robot_description(render_mode: str, initial_keyframe: str) -> str:
    package_share_dir = Path(get_package_share_directory("franka_fr3_mujoco"))
    robot_description_template = package_share_dir / "config" / "fr3.urdf.template"
    mujoco_model_path = package_share_dir / "model" / "scene.xml"
    ...
    return LaunchDescription(
        [
            DeclareLaunchArgument(
                ...
                description="MuJoCo render mode for the FR3 example.",
            ),
            DeclareLaunchArgument(
                "initial_keyframe",
                default_value="home",
