...
romujoco::MobileBaseInfo make_info() {
...
int main() {
  ...
  <body name="base" pos="1 2 0.3"><freejoint name="base_free"/><geom type="sphere" size=".05" mass="1"/>
    ...
    romujoco::MobileBaseComponent base(make_info());
    romujoco::MobileBaseCommand command;
    command.mode = romujoco::MobileBaseControlMode::Twist;
