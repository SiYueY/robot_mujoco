...
def generate_launch_description() -> LaunchDescription:
    ...
    default_model_path = str(package_file("model", "turtlebot3", "scene_turtlebot3_waffle_pi.xml"))
    default_template_path = str(
        package_file("config", "turtlebot3", "turtlebot3_waffle_pi.urdf.template")
    )
    default_controllers_path = str(package_file("config", "turtlebot3", "controllers.yaml"))
    default_rviz_config = str(package_file("config", "turtlebot3", "turtlebot3_mujoco.rviz"))
    default_robocasa_config = str(package_file("config", "turtlebot3", "robocasa_scene.yaml"))
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("primary_controller", default_value="diff_drive_controller"),
